 ...
 */
@ApiModel(description = "Description that may be available for the statement fee rate type.")
@Validated
...
public class OBExternalStatementFeeRateType1Code   {
  ...
  public String toString() {
    ...
    sb.append("class OBExternalStatementFeeRateType1Code {\n");
