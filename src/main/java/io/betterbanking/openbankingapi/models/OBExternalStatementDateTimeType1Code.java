 ...
 */
@ApiModel(description = "Date time type, in a coded form.")
@Validated
...
public class OBExternalStatementDateTimeType1Code   {
  ...
  public String toString() {
    ...
    sb.append("class OBExternalStatementDateTimeType1Code {\n");
