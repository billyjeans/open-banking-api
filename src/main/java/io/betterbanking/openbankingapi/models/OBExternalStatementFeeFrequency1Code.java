 ...
 */
@ApiModel(description = "How frequently the fee is applied to the Account.")
@Validated
...
public class OBExternalStatementFeeFrequency1Code   {
  ...
  public String toString() {
    ...
    sb.append("class OBExternalStatementFeeFrequency1Code {\n");
