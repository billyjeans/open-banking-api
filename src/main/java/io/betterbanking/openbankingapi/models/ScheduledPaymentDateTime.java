 ...
 */
@ApiModel(description = "The date on which the scheduled payment will be made.All dates in the JSON payloads are represented in ISO 8601 date-time format.  All date-time fields in responses must include the timezone. An example is below: 2017-04-05T10:43:07+00:00")
@Validated
...
public class ScheduledPaymentDateTime   {
  ...
  public String toString() {
    ...
    sb.append("class ScheduledPaymentDateTime {\n");
