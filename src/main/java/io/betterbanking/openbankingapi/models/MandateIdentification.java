 ...
 */
@ApiModel(description = "Direct Debit reference. For AUDDIS service users provide Core Reference. For non AUDDIS service users provide Core reference if possible or last used reference.")
@Validated
...
public class MandateIdentification   {
  ...
  public String toString() {
    ...
    sb.append("class MandateIdentification {\n");
