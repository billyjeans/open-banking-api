 ...
 */
@ApiModel(description = "Statement value type, in a coded form.")
@Validated
...
public class OBExternalStatementValueType1Code   {
  ...
  public String toString() {
    ...
    sb.append("class OBExternalStatementValueType1Code {\n");
