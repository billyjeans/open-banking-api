 ...
 */
@ApiModel(description = "Unique and unambiguous identification of a financial institution or a branch of a financial institution.")
@Validated
...
public class Identification2   {
  ...
  public String toString() {
    ...
    sb.append("class Identification2 {\n");
