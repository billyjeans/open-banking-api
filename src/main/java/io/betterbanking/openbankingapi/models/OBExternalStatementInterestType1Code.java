 ...
 */
@ApiModel(description = "Interest amount type, in a coded form.")
@Validated
...
public class OBExternalStatementInterestType1Code   {
  ...
  public String toString() {
    ...
    sb.append("class OBExternalStatementInterestType1Code {\n");
