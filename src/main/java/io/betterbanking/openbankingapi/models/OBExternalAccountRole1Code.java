 ...
 */
@ApiModel(description = "A party’s role with respect to the related account.")
@Validated
...
public class OBExternalAccountRole1Code   {
  ...
  public String toString() {
    ...
    sb.append("class OBExternalAccountRole1Code {\n");
