...
import io.betterbanking.openbankingapi.models.OBReadDirectDebit2;
...
public interface DirectDebitsApi {
    ...
    ResponseEntity<OBReadDirectDebit2> getDirectDebits(@ApiParam(value = "An Authorisation Token as per https://tools.ietf.org/html/rfc6750" ,required=true) @RequestHeader(value="Authorization", required=true) String authorization
