...
import io.betterbanking.openbankingapi.models.OBReadBeneficiary5;
...
public interface BeneficiariesApi {
    ...
    ResponseEntity<OBReadBeneficiary5> getBeneficiaries(@ApiParam(value = "An Authorisation Token as per https://tools.ietf.org/html/rfc6750" ,required=true) @RequestHeader(value="Authorization", required=true) String authorization
