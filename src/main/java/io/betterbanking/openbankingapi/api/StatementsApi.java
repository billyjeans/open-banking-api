...
import io.betterbanking.openbankingapi.models.OBReadStatement2;
...
public interface StatementsApi {
    ...
    ResponseEntity<OBReadStatement2> getStatements(@ApiParam(value = "An Authorisation Token as per https://tools.ietf.org/html/rfc6750" ,required=true) @RequestHeader(value="Authorization", required=true) String authorization
