...
import io.betterbanking.openbankingapi.models.OBReadStandingOrder6;
...
public interface StandingOrdersApi {
    ...
    ResponseEntity<OBReadStandingOrder6> getStandingOrders(@ApiParam(value = "An Authorisation Token as per https://tools.ietf.org/html/rfc6750" ,required=true) @RequestHeader(value="Authorization", required=true) String authorization
