...
import io.betterbanking.openbankingapi.models.OBReadScheduledPayment3;
...
public interface ScheduledPaymentsApi {
    ...
    ResponseEntity<OBReadScheduledPayment3> getScheduledPayments(@ApiParam(value = "An Authorisation Token as per https://tools.ietf.org/html/rfc6750" ,required=true) @RequestHeader(value="Authorization", required=true) String authorization
