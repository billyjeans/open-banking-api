...
import io.betterbanking.openbankingapi.models.OBReadBalance1;
...
public interface BalancesApi {
    ...
    ResponseEntity<OBReadBalance1> getBalances(@ApiParam(value = "An Authorisation Token as per https://tools.ietf.org/html/rfc6750" ,required=true) @RequestHeader(value="Authorization", required=true) String authorization
